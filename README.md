...
| 파일 (v0.9.2) | 폰트 | 결과 ISO MD5 |
|---|---|---|
| `sfa-korean-v0.9.2-malgun.zip` | 맑은 고딕 Bold | `462ebe0bed48186862db3f3da421b6fe` |
| `sfa-korean-v0.9.2-pretendard.zip` | Pretendard Bold | `d07c91d6221037095d408dbc2b0c90e4` |
